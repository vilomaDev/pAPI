...
function connectToNxCloudIfExplicitlyAsked(opts) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        if (opts['cloud'] === true) {
            ...
            const nxCommand = (0, fs_1.existsSync)((0, path_1.join)(workspace_root_1.workspaceRoot, 'package.json'))
                ? `${pmc.exec} nx`
                : process.platform === 'win32'
                    ? './nx.bat'
                    : './nx';
            (0, child_process_1.execSync)(`${nxCommand} connect-to-nx-cloud`, {
                stdio: [0, 1, 2],
            });
...
function connectToNxCloudCommand(promptOverride) {
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        (0, child_process_1.execSync)(`${nxCommand} g @nrwl/nx-cloud:init`, {
            stdio: [0, 1, 2],
        });
        return true;
    });
