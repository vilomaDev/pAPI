    ...
    function getInstalledPackageVersion(packageName, overrides) {
        try {
            ...
            if (!cache[packageName]) {
                const { packageJson, path } = (0, package_json_1.readModulePackageJson)(packageName, [
                    root,
                ]);
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const migrator = new Migrator({
                ...
                from: opts.from,
                to: opts.to,
                interactive: opts.interactive && !is_ci_1.isCI,
...
function runMigrations(root, opts, args, isVerbose, shouldCreateCommits = false, commitPrefix) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        if (!__dirname.startsWith(workspace_root_1.workspaceRoot)) {
            ...
            const pmc = (0, package_manager_1.getPackageManagerCommand)();
            (0, child_process_1.execSync)(`${pmc.exec} nx migrate ${args.join(' ')}`, {
